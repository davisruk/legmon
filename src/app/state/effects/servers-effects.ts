...
export class ServersEffects {
  ...
  @Effect()
  loadServer$: Observable<any> = this.actions.pipe(
  ...
  @Effect()
  checkServerStatus$: Observable<any> = this.actions.pipe(
  ...
  @Effect()
  uploadServer$: Observable<any> = this.actions.pipe(
  ...
  @Effect()
  checkStatusForServers$: Observable<any> = this.actions.pipe(
  ...
  @Effect()
  checkStatusForAllServers$: Observable<any> = this.actions.pipe(
  ...
  @Effect()
  checkStatusForServer$: Observable<any> = this.actions.pipe(
